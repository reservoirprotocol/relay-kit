...
const SwapActionPage: NextPage = () => {
  ...
  const [tradeType, setTradeType] = useState<"EXACT_INPUT" | "EXACT_OUTPUT">("EXACT_INPUT")
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <input placeholder='Currency address being swapped into?' value={toCurrency} onChange={(e) => setToCurrency(e.target.value)} />
      </div>
      <div>
      ...
      <div>
        ...
        <input placeholder='Currency address being swapped from?' value={fromCurrency} onChange={(e) => setFromCurrency(e.target.value)} />
      </div>
      <div>
        <label>Amount: </label>
